...
LSTM is used in cmix \cite{cmix}, which produces the best compression ratio on the enwik8 and enwik9 files, as well as 
the Canterbury corpus \cite{LosslessBenchmark}.
